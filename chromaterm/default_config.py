...
def write_default_config(path: Union[str, Path]) -> bool:
    ...
    # Ensure the parent directory exists (within permissions)
    try:
    ...
    try:
        destination.write_text(generate_default_rules_yaml(), encoding='utf-8')
    except OSError:
        return False
